...
class DomishStreamTestsMixin:
    ...
    def test_attributesWithNamespaces(self):
        ...
        xml = b"""<root xmlns:test='http://example.org' xml:language='en'>
...
class SerializerTests(unittest.TestCase):
    ...
    def testXMLNamespace(self):
        e = domish.Element(
            (None, "foo"),
            attribs={("http://www.w3.org/XML/1998/namespace", "language"): "en_US"},
        )
        self.assertEqual(e.toXml(), "<foo xml:language='en_US'/>")
